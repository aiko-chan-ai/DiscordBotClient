        ...
        let i = setInterval(() => {
            if (window.webpackChunkdiscord_app?.length) {
                ...
                !(function () {
					...
					function t() {
						let t = [];
						for (let n of Object.values(e().c))
							n.exports &&
								n.exports !== window &&
								t.push(n.exports);
						return t;
					...
					function i(e, t) {
						...
						for (let n of Object.getOwnPropertyNames(e)) {
							try {
								...
								console.warn(
									'%c[discord.js-pure] %cFailed to access property',
									'color: purple',
									'',
									n,
									e,
					...
					function s(e, t) {
						...
						for (let r of t) {
							if (
								e &&
								['object', 'function'].includes(typeof e) &&
								r in e
							)
								continue;
							let o = null;
							for (let i of Object.getOwnPropertyNames(e)) {
								...
								if (
									s &&
									['object', 'function'].includes(typeof s) &&
									r in s
								) {
									o = i;
									break;
					...
					function l(t, n = !1) {
						...
						let { m: o, c: i } = e(),
							s = Object.entries(o).filter(([, e]) =>
								t.test(e.toString()),
							);
						if (!n)
							return i[
								s.find(([e]) => i[e]?.exports)?.[0] || null
							]?.exports;
						{
							let l = [];
							for (let [a] of s) {
					...
					var a = {
						...
						_getModule(e, t = !1) {
							...
							if (Array.isArray(e[0]))
								return (
									t ? this.findByPropsAll : this.findByProps
								)(...e[0]);
							{
								let a = e[0];
								switch (typeof a) {
					...
					let {
						...
						_ = d(
							() =>
								new (a.findByProps(
									'logger',
								).logger.constructor)('discord.js-pure'),
						);
					function b() {
					...
					let v = (e, t, n) =>
						...
						T = (e) =>
							a
								...
								.setDeveloperOptionSettings(e),
						B = (e) =>
							a
								.findByProps('toggleGuildFolderExpand')
					...
					var S = {
						_patchModule(e, t, n, r, o) {
							if (!t)
								throw TypeError(
									'Must specify the module to patch',
								);
							if (!n)
								throw TypeError(
									'Must specify what function to patch',
								);
							if ('function' != typeof t[n])
								throw TypeError('Function to patch not found');
						...
						unpatch(e, t, n) {
							if (!e)
								throw TypeError(
									'You must specify a module to unpatch',
								);
							if (!t)
								throw TypeError(
									'You must specify a function to unpatch',
								);
							if (void 0 === n) {
								e[t] = k[t];
								for (var r = 0; r < G.length; r += 1)
									G[r].patchOn == t && G.splice(r, 1);
							} else
								for (let o of (this.unpatchAll(e, t),
								!(function (e) {
									for (var t = 0; t < G.length; t += 1)
										G[t].signature == e && G.splice(t, 1);
								})(n),
								G))
									this._patchModule(
										o.patchType,
					...
					let I = (e) => a.findByProps('loginToken').loginToken(e),
						...
						E = () =>
							a.getModule('getLastSelectedGuildId').getGuildId(),
						j = () =>
							a
					...
					function A(e) {
						let t = [];
						for (let n of Object.getOwnPropertyNames(D)) {
							let r = D[n];
							'function' == typeof r &&
								r.toString().includes(e) &&
								t.push(r);
						}
					...
					var N = {
						...
						route: (e) => A('transitionTo - Transitioning to ')(e),
						replace: (e) => A('Replacing route with ')(e),
						back: () => A('.goBack()')(),
						forward: () => A('.goForward()')(),
						guild: (e) => A('transitionToGuild')(e),
						channel(e) {
						...
						message(e, t) {
							let n = a
								...
								.getChannel(e)?.guild_id;
							return A('transitionToGuild')(n, e, t);
						},
					};
					let { React: x, ReactDOM: L } = p;
					var z = Object.freeze({
						__proto__: null,
						React: x,
						ReactDOM: L,
						...
						showNotification: function (
							e,
							t,
							n = 'https://cdn.discordapp.com/embed/avatars/0.png',
							{ sound: r = 'message1', volume: o = 0.4 },
						) {
							a.findByProps('showNotification').showNotification(
								n,
								e,
								t,
								null,
						...
						playSound: function (e = 'message1', t = 0.4) {
					...
					let {
						...
						{ currentGuild: V, currentChannel: Z } = {
							get currentGuild() {
								a.getModule('getGuild', 'getGuilds').getGuild(
									E(),
								);
							},
							get currentChannel() {
								a.getModule('hasChannel').getChannel(j());
							},
						};
					var J = Object.freeze({
						__proto__: null,
						__version__: { version: '5.0', nightly: !0 },
						socket: q,
						dispatcher: Y,
						http: $,
						strings: K,
						...
						dispatch: function (e, t) {
							_.verbose(`DirtyDispatching ${e.toUpperCase()}...`),
								(t.type = e.toUpperCase());
							let { dispatcher: n } = p;
							n.isDispatching()
								? setTimeout(n.dispatch.bind(n, t), 0)
								: n.dispatch(t);
						},
						loginToken: I,
						getToken: O,
					});
					(window.DiscordTools = J),
						(window.Client = class {
							constructor() {
							...
							connect() {
								S.after(
									...
									'__discord.js-pure_internal_client_hook',
								),
									(this._connected = !0),
									_.info(
										'Successfully hooked into the client!',
									);
							}
							disconnect() {
								S.unpatch(
									...
									(this._connected = !1),
									_.info(
										'Successfully unhooked from the client!',
									);
							}
							on(e, t, n = !1) {
								if (n)
									return (
										...
										() =>
											this.events[e].splice(
												this.events[e].indexOf(t),
												1,
											)
									);
								{
							...
							async emit(e, t) {
								if (void 0 !== this.events[e])
									for (let n of this.events[e])
										try {
											await n(t);
										} catch (r) {
											_.error(
												`Error in '${e}', callback: '${r}'`,
											);
										}
							}
							get sessionID() {
								return a
									.getModule('getSessionId')
									.getSessionId();
							}
							get fingerprint() {
								return a
									.getModule('getFingerprint')
									.getFingerprint();
							}
							get requiredAction() {
							...
							sendMessage(
								...
								if (!t && !i)
									throw TypeError(
										'Must provide either content or stickerIDs',
									);
								if (!e)
									throw TypeError(
										'Must provide a channel ID',
									);
								let s = {};
								return (
									null != r && (s.messageReference = r),
									null != o && (s.allowedMentions = o),
									null != i && (s.stickerIds = i),
									a.getModule('sendMessage').sendMessage(
										e,
										{
											content: t,
											tts: n,
							...
							sendEphemeralMessage(
								...
								let u = v(e, t, n);
								return (
									(u.author = r || this.user),
									(u.type = o),
									(u.tts = i),
									(u.sticker_ids = s),
									(u.message_reference = l),
									(u.allowed_mentions = a),
									P(u.channel_id, u)
								);
							}
							...
							acceptInvite(e, t = !0) {
								...
								return (
									t
										? n.acceptInviteAndTransitionToInviteChannel
										: n.acceptInvite
								)({ inviteKey: e });
							}
						}),
						b(),
						console.log(
							'%c[DiscordBotClient] %cLoaded successfully!',
							'color: purple',
							'',
						);
					resolve();
